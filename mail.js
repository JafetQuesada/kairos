...
this.enviar_pedido = (nombre, correo, telefono, descripcion) => {
    ...
    let mail_options = {
        from: `${correo}`,
        to: 'alimentosKairosymas@gmail.com',
        subject: 'Confirmación de pedido',
        html: `
            <table border="0" cellpadding="0" cellspacing="0" width="600px" background-color="#dd969c" bgcolor="#dd969c">
                <tr height="200px">  
                    <td bgcolor="" width="600px">
                        <h1 style="color: #4b2c21; text-align:center">Pedido de</h1>
                        <p  style="color: #4b2c21; text-align:center">
                            <span style="color: #fff">${nombre}</span> 
                        </p>
                        <p style="color: #4b2c21; text-align:center">Descripción del pedido: ${descripcion}</p>
                    </td>
                </tr>
                <tr bgcolor="#fff">
                    <td style="text-align:center">
                        <p style="color: #4b2c21">Contacto de teléfono ${telefono}</p>
                    </td>
                </tr>
            </table>
        `
